...
(define-trait creators-data-storage-trait
    (
        ...
        (create-profile (principal (string-utf8 32) (buff 64)) (response bool uint))
        (update-profile (principal (string-utf8 32) (buff 64)) (response bool uint))
        ;;(get-creator (principal) (response (optional {name: uint, description-hash: (buff 64), products: (list 10 uint), tier: uint}) uint))
        ;;(get-creator-tier (principal) (response uint uint))
        ;;(get-creator-products (principal) (response (list 10 uint) uint))
        ;;(get-product (uint) (response (optional {creator: principal, price: uint, amount-sold: uint, data-hash: (buff 64)}) uint))
        (create-product (principal uint (buff 64)) (response uint uint))
        (update-product (principal uint uint (buff 64)) (response bool uint))
...
(define-public (create-profile (display-name (string-utf8 32)) (new-description-hash (buff 64)) (creators-data-storage-ref <creators-data-storage-trait>))
    (begin 
...
(define-public (update-profile (display-name (string-utf8 32)) (new-description-hash (buff 64)) (creators-data-storage-ref <creators-data-storage-trait>))
    (begin 
        (asserts! (is-eq (contract-of creators-data-storage-ref) (var-get creators-data-storage-principal)) err-invalid-creators-data-storage-reference)
...
(define-public (create-product (new-price uint) (new-data-hash (buff 64)) (creators-data-storage-ref <creators-data-storage-trait>))
    (begin 
        (asserts! (is-eq (contract-of creators-data-storage-ref) (var-get creators-data-storage-principal)) err-invalid-creators-data-storage-reference)
...
(define-public (update-product (product-id uint) (new-price uint) (new-data-hash (buff 64)) (creators-data-storage-ref <creators-data-storage-trait>))
    (begin 
        (asserts! (is-eq (contract-of creators-data-storage-ref) (var-get creators-data-storage-principal)) err-invalid-creators-data-storage-reference)
